		...
		<section class="cursuri">
			...
			<div class="container">
				...
				<?php } ?>
					...
					<div class="col-xs-12 text-center"><a class="btn btn-lg btn-ghost-type_two" href="/cursuri/">Vezi alte activitati</a></div>
...
function bufnita_footer_categories() {
	...
	foreach ( $results as $cat ) {
		$categories[esc_attr($cat->name)] = get_site_url() . '/cursuri/?categ=' . $cat->slug;
	}
	$wpdb = $old_query;
	return $categories;
}
